...
constructor(
...
) : SingleUseCase<List<GHRepository>, RetrieveUserRepositoriesUseCase.Params>(executionSchedulers) {
    ...
    override fun buildUseCaseObservable(params: Params?, fresh: Boolean): Single<List<GHRepository>> = Single.defer {
        if (fresh) {
