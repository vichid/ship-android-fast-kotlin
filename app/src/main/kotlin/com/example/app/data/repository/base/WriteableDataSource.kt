...
interface WriteableDataSource<K, V : Identifiable<K>> {
     ...
     */
    fun putElement(value: V): Observable<V>
     ...
     */
    fun putAllElements(values: Collection<V>): Observable<Collection<V>>
     ...
     */
    fun deleteElement(key: K): Observable<Any>

    /**
     * Delete all the values stored in this data source.
     */
    fun deleteAllElements(): Observable<Any>
}
